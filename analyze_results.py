...
# --- 配置區塊 (在此修改參數) ---
# ==========================================
MODE = "melody"               # 分析模式: "melody", "accomp", "both"
SAVE_CHART = "melody_evaluation_chart.png"
...
PRED_MELODY_PATH = r"F:\專題\piano-mir-melody-separation\results_mel_task\accompaniment_no_hint.wav"
